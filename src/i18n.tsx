...
const EN: Record<string, string> = {
  ...
  可选: "Optional",
  删除分组: "Delete group",
  "分组名已存在": "Group name already exists",
  "如：生产环境": "e.g. Production",
  "生产环境的连接，删除/FLUSH 等危险操作将强制二次确认。": "Connections in a production group require extra confirmation for dangerous ops (delete/FLUSH).",
  "组内连接将移至默认组。": "Connections in this group will move to the default group.",
  "新建分组（名称/环境/颜色）": "New group (name/env/color)",
